...
<body>
	...
	<head>
		...
		<title>Bauhinia/Women/Jeans</title>
	</head>
	<body class="bg-dark">
		...
		<div class="row">
			<div class="text-center intro text-warning">
				<b><h1>Welcome To Bauhinia's Women Jeans Section</h1></b>
				<br><br>
			</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia design petite slim mom jeans in washed black</p><br>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia design tall denim bermuda shorts in lightwash blue</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia flare jeans with split hem detail in blue</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia tall belted skinny jeans in mid blue</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.7500.00</h5>
						<p class="card-text">
						Bauhinia straight leg jean with rip in black</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.6800.00</h5>
						<p class="card-text">
						Bauhinia baggy cord panel jeans in tan</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					<img src="51.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<h5 class="card-title">Rs.9000.00</h5>
						<p class="card-text">
						Bauhinia weekend collective laser print denim co-ord</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.7600.00</h5>
						<p class="card-text">
						Bauhinia high waist jeans in brown checkerboard denim co-ord</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
