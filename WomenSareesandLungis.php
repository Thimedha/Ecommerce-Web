...
<body>
	...
	<head>
		...
		<title>Bauhinia/Women/Sarees and Lungis</title>
	</head>
	<body class="bg-dark">
		...
		<div class="row">
			<div class="text-center intro text-warning">
				<b><h1>Welcome To Bauhinia's Saree and Lungi Section</h1></b>
				<br><br>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia batik blue colour saree</p><br>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia festive wear pink Colour saree in linen fabric</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.23000.00</h5>
						<p class="card-text">
						Bauhinia Indian bride saree</p><br><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.9500.00</h5>
						<p class="card-text">
						Bauhinia bollywood silk blend saree</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					<img src="58.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<h5 class="card-title">Rs.7800.00</h5>
						<p class="card-text">
						Bauhinia Indian lungi kurta rose</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.18500.00</h5>
						<p class="card-text">
						Bauhinia Srilankan kandian bride saree</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.15900.00</h5>
						<p class="card-text">
						Bauhinia India green linen floral print jacket and lungi skirt set</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
