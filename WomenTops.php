...
<body>
	...
	<head>
		...
		<title>Bauhinia/Women/Tops</title>
	</head>
	<body class="bg-dark">
		...
		<div class="row">
			<div class="text-center intro text-warning">
				<b><h1>Welcome To Bauhinia's Women Tops Section</h1></b>
				<br><br>
			</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia heartbreak cotton poplin shirt in bright pink</p><br>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia design bardot short sleeve top in black</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia multi channel ruched poplin top in pink</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia river island ruffle front blouse in blue print</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.4500.00</h5>
						<p class="card-text">
						Bauhinia design denim oversized shirt in blue</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.5000.00</h5>
						<p class="card-text">Bauhinia design oversized t-shirt with guns n roses license graphic in stone</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia premium large broderie oversized shirt with scalloped hem in black</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia luxe co-ord fan satin crop top in blue</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
