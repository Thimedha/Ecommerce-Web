  ...
  <div class="row">
    ...
    <div class="col-md-4 bg-dark">
      <form method = "post" action="RegisterInsertController.php">
        ...
        <div class="mb-3">
          <b><h1 class="text-center text-warning">Buy Your Item</h1></b><br>
        </div>
        <div class="mb-2 text-center">
          <b><h1><img src="154.jpg"></h1></b><br>
        </div>
        <div class="mb-3">
          <label for="ProductCategory" class="form-label text-white">Product Category</label>
          <input type= "text-white" class="form-control" id="ProductCategory" value="Sunglass" readonly>
        </div>
        <div class="mb-3">
          <label for="ProductName" class="form-label text-white">Product Name</label>
          <input type="text-white" class="form-control" id="ProductName" value="Bauhinia Navigator Unisex Sunglass" readonly>
        </div>
        <div class="mb-3">
