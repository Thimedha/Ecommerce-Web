...
<body>
	...
	<head>
		...
		<title>Bauhinia/Women/Dresses</title>
	</head>
	<body class="bg-dark">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link active" href="Women.php">Women</a>
						</li>
						<li class="nav-item">
		...
		<div class="row">
			<div class="text-center intro text-warning">
				<b><h1>Welcome To Bauhinia's Women Dresses Section</h1></b>
				<br><br>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia design sleeveless fallen shoulder mini dress in black</p>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.9000.00</h5>
						<p class="card-text">Bauhinia lounge embellished short sleeve maxi dress in teal</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia long sleeve v neck printed mini dress in black and white</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.6000.00</h5>
						<p class="card-text">
						Bauhinia cowl neck open back mini dress in pink</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.12500.00</h5>
						<p class="card-text">
						Bauhinia bridesmaid emellished bodice maxi dress with flutter sleeve</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.7000.00</h5>
						<p class="card-text">Bauhinia design batwing twist front midi skater dress in navy</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.8500.00</h5>
						<p class="card-text">
						Bauhinia abstract swirl full skirt midi dress in blue</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.6500.00</h5>
						<p class="card-text">
						Bauhinia square neck mini smock sundress in white</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
