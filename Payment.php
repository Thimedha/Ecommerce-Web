			...
			<div class="row">
				...
				<div class="col-md-5 bg-dark">
					<form>
						...
						<div class="mb-3">
							<b><h1 class="text-center text-warning">Payment Details</h1></b><br>
							
						<div class="mb-3">
							<label for="" class="form-label text-white">Payment Method</label><br>
							<select name="Sizes" id="Sizes" class="text-center">
								<option value="CreditCard">Credit Card</option>
								<option value="CashOnDeivery">Cash On Delivery</option>
								
							</select>
						</div>
						<div class="mb-3">
							<label for="CardHolderName" class="form-label text-white">Card Holder's Name</label>
							<input type="CardHolderName" class="form-control" id="CardHolderName">
						...
						<div class="mb-3">
							<label for="CVVNumber" class="form-label text-white">CVV Number
							</label>
							<input type="CVVNumber" class="form-control" id="CVVNumber">
						</div>
						<div class="mb-3">
							<label for="ExpireDate" class="form-label text-white">Expire Date
							</label>
