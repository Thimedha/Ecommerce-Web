...
<head>
  ...
  <title>Bauhinia/Contact Us</title>
...
<body class="bg-dark">
  ...
  <div class="row">
    ...
    <div class="col-md-6 bg-dark">
      <form method = "post" action="ContactUs_Insert_Controller.php">

        <div class="mb-3">
          <b><h1 class="text-center text-warning">Bauhinia's Contact Us</h1></b>
        ...
        <div class="mb-3">
          ...
          <input type="text-white" class="form-control" name="ContactNumber"id="ContactNumber">
          
        </div>

        <div class="mb-3">
          <label for="Message" class="form-label text-white">Message</label>
          <input type="text-white" class="form-control" name="Message" id="Message">
        </div>
