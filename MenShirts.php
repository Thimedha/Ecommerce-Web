...
<body>
	...
	<head>
		...
		<title>Bauhinia/Men/Shirts</title>
	</head>
	<body class="bg-dark">
		...
		<div class="row">
			<div class="text-center intro text-warning">
				<b><h1>Welcome To Bauhinia's Men Shirts Section</h1></b>
				<br><br>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">Bauhinia lauren traveller paisley print co-ord</p><br>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					<img src="62.jpg" class="card-img-top" alt="...">
					<div class="card-body">
						<h5 class="card-title">Rs.6000.00</h5>
						<p class="card-text">Bauhinia originals plisse in black co-ord</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia jeans couture tapestry shirt in blue</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.6200.00</h5>
						<p class="card-text">
						Bauhinia design shirt in black and white buffalo check</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia chicago bulls script mesh t-shirt in white</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.5800.00</h5>
						<p class="card-text">Bauhinia design relaxed t-shirt in stripe with city embroidery</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						<h5 class="card-title">Rs.7500.00</h5>
						<p class="card-text">
						Bauhinia design boxy oversized shirt in navy paisley bandana print</p>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
			...
			<div class="col-md-2">
				<div class="card" style="width: 15rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
						Bauhinia WIP seek hoodie in black</p><br>
						<a href="#" class="btn btn-primary">Buy</a>
						<a href="#" class="btn btn-dark">Add to Cart</a>
					</div>
				</div>
